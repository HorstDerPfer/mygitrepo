 ...
 */
public class TerminBerechnung_B_EVU_Deadline2010_Test {
	...
	public void testCalculateStellungnahmeEVU() {
		final Date STELLUNGNAHME_EVU = new GregorianCalendar(2010, GregorianCalendar.JULY, 26)
		    .getTime();
	...
	public void testCalculateUeB_PV() {
		final Date UEB_PV = new GregorianCalendar(2010, GregorianCalendar.AUGUST, 6).getTime();
