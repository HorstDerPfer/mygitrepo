...
/**
 * Test für die Berechnung von Soll-Terminen bei BOB-Baumassnahmen mit Art = QS für Schnittstelle
 * Baubetriebsplanung für Baumassnahmen mit Baubeginn ab 2010-01-01
 * 
 */
public class TerminBerechnung_QS_Baubetriebsplanung_Deadline2010_Test {
	...
	public void testCalculateKoordinationsergebnis() {
		final Date KOOREDINATIONSERGEBNIS = new GregorianCalendar(2010, GregorianCalendar.APRIL, 28)
		    .getTime();
