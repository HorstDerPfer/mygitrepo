		...
		<jsp:include page="../main_path.jsp" />
			<jsp:include page="../main_menu.jsp" />
				...
				<script type="text/javascript">
				    openMainMenu('navLink_auswertung-statAusfall');
				</script>
				
				<html:form action="/statistics/statAusfall">
					<jsp:include page="suche.jsp" />
				</html:form>
				<br />

				<div class="textcontent_head">
				    <bean:message key="menu.auswertungen.failures" />
				</div>
				<div class="textcontent" style="text-align:center;">
					...
					<display:table
						...
						name="reportBean" 
						export="true"
						requestURI="/statistics/statAusfall.do" 
						pagesize="20" 
						sort="list"
						class="colored"
						...
						<display:column property="ausfallCount" titleKey="auswertungen.ausfall.ausfallcount" sortable="true" />
						<display:column property="costs" titleKey="auswertungen.ausfall.costs" sortable="true" />
					</display:table>
				</div>
