		...
		<jsp:include page="../../main_path.jsp" />
			<jsp:include page="../../main_menu.jsp" />
				...
				<script type="text/javascript">
				    openMainMenu('navLink_auswertung-statUebKsQsZuege');
				</script>
				
				<html:form action="/statistics/statUebKsQsZuege">
					<jsp:include page="../suche.jsp" />
				</html:form>
				<br />

				<div class="textcontent_head">
				    <bean:message key="auswertungen.anzahlQsKsZuegeGesamt" />
				</div>
				<div class="textcontent" style="text-align:center;">
					<display:table
						...
						export="true"
						requestURI="/statistics/statUebKsQsZuege.do" 
						pagesize="20" 
						sort="list"
						class="colored">
						
						<display:column property="label" titleKey="auswertungen.noTitle" sortable="false" style="width:200px"/>
						<display:column property="anzahl" titleKey="auswertungen.anzahlQsKsZuege" sortable="true" />
					</display:table>
				</div>
				<br>
				
				<div class="textcontent_head">
				    <bean:message key="auswertungen.anzahlQsKsZuegeEVUKundengruppe" />
				</div>
				<div class="textcontent" style="text-align:center;">
					<display:table
						id="currentRow2" 
