		...
		<jsp:include page="../main_path.jsp" />
			<jsp:include page="../main_menu.jsp" />
				...
				<script type="text/javascript">
				    openMainMenu('navLink_auswertung-statChanges');
				</script>
				
				<html:form action="/statistics/statChanges">
				...
				<div class="textcontent" style="text-align:center;">
					...
					<display:table
						...
						name="reportBean" 
						export="true"
						requestURI="/statistics/statChanges.do" 
						pagesize="20" 
						sort="list"
						class="colored"
						...
						<display:column property="changedCount" titleKey="auswertungen.changes.changedcount" sortable="true" />
						<display:column property="costs" titleKey="auswertungen.changes.costs" sortable="true" />
					</display:table>
				</div>
