...
<div class="textcontent_head"><bean:message key="topprojekt.massnahmen" /></div>
<div class="textcontent center">
	...
	<display:table
		...
		<display:column property="massnahmeId" titleKey="paket.id" sortable="true" />
