...
<thead>
	<tr>
		...
		<th rowspan="2">
			<div style="text-align:center;"><bean:message key="ueb.zug.zuggattung.short" /></div>
		</th>
		<th rowspan="2">
			<div style="text-align:center;"><bean:message key="ueb.zug.zugnr.short" /></div>
		</th>
		<c:if test="${abweichungstyp==artUmleitung }">
			<th rowspan="2">
		...
		<c:if test="${abweichungstyp==artRegelung }">
			<th>
				<div style="text-align:center;"><bean:message key="ueb.zug.regelungsart" /></div>
			</th>
			<th>
				<div style="text-align:center;"><bean:message key="ueb.zug.inbst" /></div>
			</th>
		</c:if>
		<c:if test="${abweichungstyp!=artUmleitung }">
			<th>
