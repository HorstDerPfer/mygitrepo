...
<%@ taglib uri="/META-INF/easy.tld" prefix="easy"  %>
				...
				<div class="textcontent_right">
					<div class="box">
						...
						<div class="input"><html:text property="zvfSenderName" styleId="name" maxlength="255"/></div>
					</div>
					<div class="box">
						<div class="label"><label for="vorname"><bean:message key="ueb.sender.vorname" /></label></div>
						<div class="input"><html:text property="zvfSenderVorname" styleId="vorname" maxlength="255"/></div>
					</div>
					<div class="box">
						<div class="label"><label for="strasse"><bean:message key="ueb.sender.strasse" /></label></div>
						<div class="input"><html:text property="zvfSenderStrasse" styleId="strasse" maxlength="255"/></div>
					</div>
					<div class="box">
						<div class="label"><label for="plz"><bean:message key="ueb.sender.plz" /></label></div>
						<div class="input"><html:text property="zvfSenderPLZ" styleId="plz" maxlength="5"/></div>
					</div>
					<div class="box">
						<div class="label"><label for="ort"><bean:message key="ueb.sender.ort" /></label></div>
						<div class="input"><html:text property="zvfSenderOrt" styleId="ort" maxlength="255"/></div>
					</div>
					<div class="box">
						<div class="label"><label for="telefon"><bean:message key="ueb.sender.tel.extern" /></label></div>
						<div class="input"><html:text property="zvfSenderTelefon" styleId="telefon" maxlength="255"/></div>
					</div>
					<div class="box">
						<div class="label"><label for="telefonIntern"><bean:message key="ueb.sender.tel.intern" /></label></div>
						<div class="input"><html:text property="zvfSenderTelefonIntern" styleId="telefonIntern" maxlength="255"/></div>
					</div>
					<div class="box">
						<div class="label"><label for="email"><bean:message key="ueb.sender.email" /></label></div>
						<div class="input"><html:text property="zvfSenderEmail" styleId="email" maxlength="255"/></div>
					</div>
				</div>