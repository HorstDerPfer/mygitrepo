...
public class UebergabeblattZugViewAction extends BaseAction {

	private BaumassnahmeService service;

	private Logger log;

	public UebergabeblattZugViewAction() {
	...
	protected ActionForward run(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (log.isDebugEnabled())
			log.debug("Entering UebergabeblattZugViewAction.");
		...
		request.setAttribute("uebZugCollection", baumassnahme.getUebergabeblatt().getMassnahmen()
