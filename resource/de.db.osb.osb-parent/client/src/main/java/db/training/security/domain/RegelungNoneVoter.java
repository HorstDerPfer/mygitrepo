...
/**
 * Voter, der abstimmt, ob ein Benutzer keine Zugriffsrechte auf eine Gleissperrung hat.
 * 
 * @author Sebastian Hennebrueder
 * 
 */
public class RegelungNoneVoter extends RegelungAnyVoter {
	...
	public boolean supports(Class clazz) {
		return clazz == Regelung.class;
	}

	/**
	 * * Gibt ACCESS_GRANTED zurueck, wenn der Benutzer eine Rolle hat, die ihm eine der
	 * requestedAuthorizations auf die Gleissperrung erlaubt.
	 * 
	 * <pre>
