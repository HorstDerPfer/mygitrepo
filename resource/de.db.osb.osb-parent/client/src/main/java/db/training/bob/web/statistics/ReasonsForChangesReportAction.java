...
public class ReasonsForChangesReportAction extends BaseSearchAction {

	private static final Logger log = Logger.getLogger(ReasonsForChangesReportAction.class);

	private BaumassnahmeService baumassnahmeService;

	public ReasonsForChangesReportAction() {
	...
	protected ActionForward run(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (log.isDebugEnabled())
			log.debug("Entering ReasonsForChangesReportAction.");
		...
		try {
			...
			Map<String, Integer> l = baumassnahmeService.findReasonsForChanges(bbps);
