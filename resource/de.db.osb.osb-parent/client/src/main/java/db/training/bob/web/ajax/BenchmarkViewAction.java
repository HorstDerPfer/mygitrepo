...
public class BenchmarkViewAction extends BaseAction {

	private BaumassnahmeService service;

	private Logger log;

	public BenchmarkViewAction() {
	...
	protected ActionForward run(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if (log.isDebugEnabled())
			log.debug("Entering BenchmarkViewAction.");
		...
		Preload[] preloads = new Preload[] { new Preload(Baumassnahme.class, "benchmark") };
