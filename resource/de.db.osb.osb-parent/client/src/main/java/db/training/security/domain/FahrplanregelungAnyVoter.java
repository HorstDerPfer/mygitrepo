 ...
 * 
 */
public class FahrplanregelungAnyVoter implements EasyAccessDecisionVoter {

	private Logger log = Logger.getLogger(FahrplanregelungAnyVoter.class);
	...
	public int vote(final TqmUser tqmUser, Object domainObject, String requestedAuthorizations) {
		Authentication authentication = new Authentication() {
			...
			private static final long serialVersionUID = 742607169978421224L;
	...
	public boolean supports(Class arg0) {
		return arg0 == Fahrplanregelung.class;
	}
	...
	public int vote(Authentication arg0, Object arg1, ConfigAttributeDefinition arg2) {
		...
		if (!(arg1 instanceof Fahrplanregelung)) {
		...
		Fahrplanregelung fahrplanregelung = (Fahrplanregelung) arg1;
				...
				for (GrantedAuthority authority : authorities) {
					if (authority.getAuthority().startsWith(configAttribute.getAttribute())) {
						...
						// Berechtigung gilt für alle Objektinstanzen des eigenen Regionalbereichs
							...
							if (fahrplanregelung.getRegionalbereich().equals(
							    user.getRegionalbereich()))
								result = ACCESS_GRANTED;
						}

						// Ausnahme fuer fixierte Objekte
						if (result == ACCESS_GRANTED && fahrplanregelung.isFixiert()) {
