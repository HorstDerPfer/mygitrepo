...
public class TerminBerechnung_KS_Test {

	private Date STARTTERMIN = new GregorianCalendar(2008, GregorianCalendar.APRIL, 19).getTime();

	private Date ANFORDERUNG_BBZR = new GregorianCalendar(2007, GregorianCalendar.OCTOBER, 15)
	    .getTime();

	private Date BIUE_ENTWURF = new GregorianCalendar(2007, GregorianCalendar.NOVEMBER, 7)
	    .getTime();

	private Date ZVF_ENTWURF = new GregorianCalendar(2007, GregorianCalendar.NOVEMBER, 7).getTime();

	// private Date KOOREDINATIONSERGEBNIS = new GregorianCalendar(2007, GregorianCalendar.APRIL,
	// 29).getTime();
	private Date STELLUNGNAHME_EVU = new GregorianCalendar(2007, GregorianCalendar.NOVEMBER, 28)
	    .getTime();

	// private Date GESAMTKONZEPT_BBZR = new GregorianCalendar(2007, GregorianCalendar.MAY,
	// 6).getTime();
	private Date BIUE = new GregorianCalendar(2008, GregorianCalendar.JANUARY, 2).getTime();

	private Date ZVF = new GregorianCalendar(2008, GregorianCalendar.JANUARY, 2).getTime();

	// private Date MASTERUEB_PV = new GregorianCalendar(2008, GregorianCalendar.JUNE,
	// 26).getTime();
	// private Date MASTERUEB_GV = new GregorianCalendar(2008, GregorianCalendar.JULY,
	// 10).getTime();
	// private Date UEB_PV = new GregorianCalendar(2008, GregorianCalendar.JULY, 24).getTime();
	// private Date UEB_GV = new GregorianCalendar(2008, GregorianCalendar.AUGUST, 7).getTime();
	private Date FPLO = new GregorianCalendar(2008, GregorianCalendar.APRIL, 4).getTime();

	private Date EINGABE_GFDZ = new GregorianCalendar(2008, GregorianCalendar.APRIL, 4).getTime();

	private Date UEB_PV_KS = new GregorianCalendar(2008, GregorianCalendar.JANUARY, 2).getTime();;

	private Date UEB_GV_KS = new GregorianCalendar(2008, GregorianCalendar.JANUARY, 2).getTime();;
	...
	// assertEquals(KOOREDINATIONSERGEBNIS,
	// TerminBerechnung.getKoordinationsErgebnisSoll(STARTTERMIN));
	// }
