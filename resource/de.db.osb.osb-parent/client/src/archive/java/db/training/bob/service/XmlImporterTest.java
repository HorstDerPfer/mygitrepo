...
import db.training.bob.model.SperrKz;
...
public class XmlImporterTest {
	...
	private static final String MAS_REGIONALBEREICH1 = "Mitte";
	...
	private static final String MAS_REGIONALBEREICH2 = "Mitte";
	...
	private static final String MAS_REGIONALBEREICH3 = "Mitte";
	...
	private SortedSet<BBPMassnahme> bbpMassnahmen = null;

	@Before
	public void setUp() throws Exception {
		BBP_XML_FILE = new File("src/osb/client/src/test/resources/db/training/bob/model/testdata",
		    "BBP_Export_3.XML");
	...
	public void testImportBBP1Data() throws Exception {
		...
		assertEquals(MAS_REGIONALBEREICH1, bbpArray[0].getRegionalbereich());
	}
	...
	public void testImportBBP2Data() throws Exception {
		...
		assertEquals(MAS_REGIONALBEREICH2, bbpArray[1].getRegionalbereich());
	}
	...
	public void testImportBBP3Data() throws Exception {
		...
		assertEquals(MAS_REGIONALBEREICH3, bbpArray[2].getRegionalbereich());
	}

	@Test
	public void testImportRegelungenData() throws Exception {

		List<BBPMassnahme> bbps = new ArrayList<BBPMassnahme>(bbpMassnahmen);

		List<Regelung> regelungen = new ArrayList<Regelung>(bbps.get(0).getRegelungen());
		assertEquals(2, regelungen.size());

		Regelung regelung1 = regelungen.get(1);
	...
	@Test
	public void testImportErstelldatum() throws Exception {
		Date expected = new GregorianCalendar(2008, GregorianCalendar.MARCH, 31).getTime();
		assertEquals(expected, xmlImporter.getErstelldatum());
	}
