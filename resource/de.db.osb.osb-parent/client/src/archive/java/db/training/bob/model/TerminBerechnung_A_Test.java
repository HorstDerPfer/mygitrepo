...
public class TerminBerechnung_A_Test {

	private Date STARTTERMIN = new GregorianCalendar(2009, GregorianCalendar.SEPTEMBER, 15)
	    .getTime();

	private Date ANFORDERUNG_BBZR = new GregorianCalendar(2009, GregorianCalendar.MARCH, 16)
	    .getTime();

	private Date BIUE_ENTWURF = new GregorianCalendar(2009, GregorianCalendar.APRIL, 8).getTime();

	private Date ZVF_ENTWURF = new GregorianCalendar(2009, GregorianCalendar.APRIL, 8).getTime();

	private Date KOOREDINATIONSERGEBNIS = new GregorianCalendar(2009, GregorianCalendar.APRIL, 29)
	    .getTime();

	private Date STELLUNGNAHME_EVU = new GregorianCalendar(2009, GregorianCalendar.APRIL, 29)
	    .getTime();

	private Date GESAMTKONZEPT_BBZR = new GregorianCalendar(2009, GregorianCalendar.MAY, 6)
	    .getTime();

	private Date BIUE = new GregorianCalendar(2009, GregorianCalendar.JUNE, 3).getTime();

	private Date ZVF = new GregorianCalendar(2009, GregorianCalendar.JUNE, 3).getTime();
	...
	private Date UEB_PV = new GregorianCalendar(2009, GregorianCalendar.JULY, 24).getTime();

	private Date UEB_GV = new GregorianCalendar(2009, GregorianCalendar.AUGUST, 7).getTime();

	private Date FPLO = new GregorianCalendar(2009, GregorianCalendar.SEPTEMBER, 4).getTime();
