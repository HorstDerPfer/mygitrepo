...
public class TerminBerechnung_QS_Test {

	private Date STARTTERMIN = new GregorianCalendar(2009, GregorianCalendar.FEBRUARY, 28)
	    .getTime();

	private Date ANFORDERUNG_BBZR = new GregorianCalendar(2008, GregorianCalendar.AUGUST, 25)
	    .getTime();

	private Date BIUE_ENTWURF = new GregorianCalendar(2008, GregorianCalendar.SEPTEMBER, 17)
	    .getTime();

	private Date ZVF_ENTWURF = new GregorianCalendar(2008, GregorianCalendar.SEPTEMBER, 17)
	    .getTime();

	private Date KOOREDINATIONSERGEBNIS = new GregorianCalendar(2008, GregorianCalendar.OCTOBER, 8)
	    .getTime();

	private Date STELLUNGNAHME_EVU = new GregorianCalendar(2008, GregorianCalendar.OCTOBER, 8)
	    .getTime();

	private Date GESAMTKONZEPT_BBZR = new GregorianCalendar(2008, GregorianCalendar.OCTOBER, 15)
	    .getTime();

	private Date BIUE = new GregorianCalendar(2008, GregorianCalendar.NOVEMBER, 12).getTime();

	private Date ZVF = new GregorianCalendar(2008, GregorianCalendar.NOVEMBER, 12).getTime();

	private Date MASTERUEB_PV = new GregorianCalendar(2009, GregorianCalendar.JUNE, 26).getTime();

	private Date MASTERUEB_GV = new GregorianCalendar(2009, GregorianCalendar.JULY, 10).getTime();

	private Date UEB_PV = new GregorianCalendar(2009, GregorianCalendar.JANUARY, 2).getTime();

	private Date UEB_GV = new GregorianCalendar(2009, GregorianCalendar.JANUARY, 16).getTime();

	private Date FPLO = new GregorianCalendar(2009, GregorianCalendar.FEBRUARY, 13).getTime();

	// private Date EINGABE_GFDZ = new GregorianCalendar(2009, GregorianCalendar.MARCH,
	// 7).getTime();
	// private Date UEB_PV_KS = new GregorianCalendar(2009, GregorianCalendar.NOVEMBER,
	// 30).getTime();;
	// private Date UEB_GV_KS = new GregorianCalendar(2009, GregorianCalendar.NOVEMBER,
	// 30).getTime();;
